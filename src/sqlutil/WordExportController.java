...
public class WordExportController { 
	public static void main(String[] args) {
		String str = "猪pig";
		String reg = "[\\u4e00-\\u9fa5]*-*[\\u4e00-\\u9fa5]*\\(*[a-zA-Z]+_*[a-zA-Z]+\\)*";
...
//	  
//	        //添加标题  
//	        XWPFParagraph titleParagraph = document_createParagraph();  
//	        //设置段落居中  
//	        titleParagraph.setAlignment(ParagraphAlignment.CENTER);  
//	  
//	        XWPFRun titleParagraphRun = titleParagraph.createRun();  
//	        titleParagraphRun.setText("abc");
//	        titleParagraphRun.setColor("000000");  
//	        titleParagraphRun.setFontSize(20);  
//	  
//	  
//	        //段落  
//	        XWPFParagraph firstParagraph = document_createParagraph();  
...
//	  
//	        //换行  
//	        XWPFParagraph paragraph1 = document_createParagraph();  
...
//	        infoTableRowOne.addNewTableCell().setText("abc");
//	  
//	        //表格第二行  
...
//	        comTableRowTwo.getCell(3).setText("abc");
//	  
//	        //表格第三行  
...
//	        comTableRowThree.getCell(3).setText("abc");
//	  
//	  
